...
* S&D are the most cohesive political group, with Renew being the third most cohesive.
* Extremes of the political spectrum tend to be less cohesive on final votes, than on not final votes (ESN exception).  Centre parties are more cohesive on final than on non final votes (Renew exception).
* Renew appears as the most cohesive in CULT, INTA, ITRE, JURI (tied), and PECH. Worst cohesion in EMPL.
...
attendance_bypolgroup |> 
  dplyr::mutate(political_group = forcats::fct_reorder(.f = political_group, 
                                                       ...
                                                       .desc = TRUE)) |>
  ggplot(aes(x = political_group, y = attendance_rate_avg,
